...
import type { AdTriggerContext, SlotResponse } from '../core/types'
import { getMessageText } from '../../../../shared/utils/message'

// ============================================================================
// 导出类型（供 MessageList.tsx 使用）
// ============================================================================
...
export const MessageListActionCardAd = memo<MessageListAdIntegrationProps>(
  ({ messages, sessionId, messageIndex, adData, children }) => {
...
export const MessageListWithAds = memo<MessageListWithAdsProps>(
  ({ messages, sessionId, renderMessage, adData }) => {
    return (
      <Stack gap="sm">
